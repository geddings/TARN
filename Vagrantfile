...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "./mininet/topologies/2-AS-ebgp/configs", "/home/vagrant/TARN/mininet/topologies/2-AS-ebgp/configs", group: "quaggavty", owner: "quagga", mount_options: ["dmode=775,fmode=775"]
