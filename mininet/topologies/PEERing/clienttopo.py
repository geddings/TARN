...
class QuaggaTopo(Topo):
    ...
    def __init__(self):
        ...
        #sw1 = self.addSwitch(name='sw1', dpid='0000000000000001', failMode='standalone')    # This switch talks to Server
        ...
        self.addLink(sw4, quaggaContainerList[0])
        self.addLink(sw3, quaggaContainerList[0])
